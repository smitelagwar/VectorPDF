// MIT License
#ifndef VECTORPDF_NAVIGATIONRULES_H
#define VECTORPDF_NAVIGATIONRULES_H
...
class VECTORPDF_ACCESSIBILITY_EXPORT NavigationRules
{
public:
...
#endif // VECTORPDF_NAVIGATIONRULES_H
